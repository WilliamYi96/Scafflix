...
def run_scafflix(local_epochs=0):
    ...
    scafflix_comp_params = Scafflix_computation2.ScafflixComputationParams(args.server_alg_type, args.client_alg_type,
    ...
    scafflix_hparams = Scafflix_computation2.ScafflixHParams(server_lr, client_lr,
                                                            args.n_clients_per_scafflix_round, scafflix_batch_size)
    scafflix_comp_params = Scafflix_computation2.ScafflixComputationParams(args.server_alg_type, args.client_alg_type,
                                                              scafflix_init_params, args.scafflix_num_rounds)
    _, stats = Scafflix_computation2.scafflix_computation_with_statistics(train_fd, test_fd, grad_fn, grad_fn_eval,
